...
class ContinuousInsertionSimGymRandomizedPointFLowEnv(ContinuousInsertionSimEnv):
    ...
    def get_obs(self, info=None, reset=False):
        ...
        # if reset == True:
        #     print("观测队列重置----------------------------------------")
        #     self.marker_flow_seq = [obs["marker_flow"], obs["marker_flow"], obs["marker_flow"], obs["marker_flow"]]
            

        # else: 
        #     self.marker_flow_seq = [self.marker_flow_seq[0], self.marker_flow_seq[1], 
        #                               self.marker_flow_seq[2], self.marker_flow_seq[3]]
        #     self.marker_flow_seq.pop(0)
        #     self.marker_flow_seq.append(obs["marker_flow"])

        # obs["marker_flow_seq"] = np.stack(self.marker_flow_seq, axis=0)
        return obs
