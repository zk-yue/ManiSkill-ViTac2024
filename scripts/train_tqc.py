...
# )
from solutions.policies_tqc import TQCPolicyForPointFlowEnv
...
TQC.policy_aliases["TQCPolicyForPointFlowEnv"] = TQCPolicyForPointFlowEnv
...
if __name__ == "__main__":
    ...
    args.cfg='configs/parameters/peg_insertion_tqc.yaml'
