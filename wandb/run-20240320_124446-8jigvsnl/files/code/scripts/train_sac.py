...
from solutions.policies_sac import (
    SACPolicyForPointFlowEnv , SACPolicyForLongOpenLockPointFlowEnv
)

# from stable_baselines3 import TD3
# from stable_baselines3 import SAC
from solutions.sac_custom import SAC
...
SAC.policy_aliases["SACPolicyForLongOpenLockPointFlowEnv"] = SACPolicyForLongOpenLockPointFlowEnv
...
if __name__ == "__main__":
    ...
    # args.cfg='configs/parameters/long_open_lock_sac.yaml'
    ...
    # model = SAC("MlpPolicy",env, verbose=1, **cfg["policy"])
    ...
    # model = SAC.load("training_log/3shape_1.5mm_2024-03-16_19-16-07.430/weights/rl_model_172000_steps.zip", env=env)
